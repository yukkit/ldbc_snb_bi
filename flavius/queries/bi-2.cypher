...
OPTIONAL /*+ BUILD LEFT */ MATCH (message1:Post|Comment)-[:postHasTag|commentHasTag]->(tag)
...
OPTIONAL /*+ BUILD LEFT */ MATCH (message2:Post|Comment)-[:postHasTag|commentHasTag]->(tag)
